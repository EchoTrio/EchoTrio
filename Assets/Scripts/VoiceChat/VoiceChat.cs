...
namespace EchoTrio {
    ...
    public class VoiceChat : MonoBehaviour {
        ...
        private async Task QueueActorOutput(string persona, string message, Emotion emotion, List<string> reasonings, AudioStream audioStream, AudioSource audioSource) {
        ...
        private IEnumerator AudioThread() {
            ...
            while (!destroyCancellationToken.IsCancellationRequested) {
                ...
                if (hasOutput) {
                    ...
                    // Display the text if this is the first chunk of a stream.
